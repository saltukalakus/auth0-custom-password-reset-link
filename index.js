...
app.get('/', function (req, res) {
    console.log("GET /")
    console.log(req.webtaskContext.headers.referer);
    if (!refererLink) {
      refererLink = req.webtaskContext.headers.referer
    }

    res.writeHead(200, { 'Content-Type': 'text/html' });
    res.end(require('ejs').render(view, {post_path:"https://"+ req.webtaskContext.headers.host + req.originalUrl + "/email"}));
});
